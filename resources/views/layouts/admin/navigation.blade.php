<ul class="nav flex-column pt-3 pt-md-0">
    ...
    <li class="nav-item {{ request()->routeIs('admin.nazir.data') ? 'active' : '' }}">
        <a href="{{ route('admin.nazir.data') }}" class="nav-link">
            <span class="sidebar-icon text-warning">
    ...
    <li class="nav-item {{ request()->routeIs('admin.nazir.kinerja') ? 'active' : '' }}">
        <a href="{{ route('admin.nazir.kinerja') }}" class="nav-link">
            <span class="sidebar-icon text-warning">
